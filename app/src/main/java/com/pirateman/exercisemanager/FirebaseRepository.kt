...
class FirebaseRepository : KoinComponent {
        ...
        exercise.name?.let {
            firestore.collection("exercises")
                ...
                .addOnSuccessListener {
                    Log.d(
                        firebaseTag,
                        "${exercise.name} successfully written"
                    )
                }
                .addOnFailureListener { e ->
                    Log.e(
                        firebaseTag,
                        "Error writing document snapshot",
                        e
                    )
                }
        }
    ...
    fun getExercises(): CollectionReference {
...
class FirebaseWorker(context: Context, params: WorkerParameters) :
